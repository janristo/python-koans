...
def test_none_has_its_own_dedicated_type():
    ...
    Vad heter typen?"""
    assert type(None).__name__ == _"NoneType"___
...
def test_bool_is_a_subclass_of_int():
    ...
    assert isinstance(True, int) == _true___
